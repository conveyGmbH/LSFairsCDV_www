...
/// <reference path="~/www/pages/faircycle/faircycleController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.FaircycleLayout", {
        ...
        },
        {
            ...
            initialize: function (site) {
                ...
                WinJS.Utilities.addClass(this._surface, "faircycleLayout");
            ...
            uninitialize: function () {
                WinJS.Utilities.removeClass(this._surface, "faircycleLayout");
                this._site = null;
                this._surface = null;
            }
        })
    ...
    var pageName = Application.getPagePath("faircycle");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [
                ...
                { id: "clickNew", label: getResourceText("command.new"), tooltip: getResourceText("tooltip.newFaircycle"), section: "primary", svg: "plus" },
                { id: "clickDelete", label: getResourceText("command.delete"), tooltip: getResourceText("tooltip.deleteFaircycle"), section: "primary", svg: "garbage_can" },
            ...
            this.controller = new Faircycle.Controller(element, commandList);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var faircycle = element.querySelector("#faircycle.listview");
                    if (faircycle && faircycle.style) {
                        ...
                        if (contentarea) {
                            ...
                            if (width !== that.prevWidth) {
                                ...
                                faircycle.style.width = width.toString() + "px";
                            }
                            if (height !== that.prevHeight) {
                                that.prevHeight = height;
                                faircycle.style.height = height.toString() + "px";
                            }
                        }
                    }
                    that.inResize = 0;
