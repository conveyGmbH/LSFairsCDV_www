...
/// <reference path="~/www/pages/faircycle/faircycleService.js" />
...
(function () {
    ...
    WinJS.Namespace.define("Faircycle", {
        Controller: WinJS.Class.derive(Application.RecordsetController, function Controller(pageElement, commandList) {
            Log.call(Log.l.trace, "Faircycle.Controller.");
            // ListView control
            var listView = pageElement.querySelector("#faircycle.listview");

            Application.RecordsetController.apply(this, [pageElement, {
                count: 0
            }, commandList, false, Faircycle.initView, null, listView]);
                ...
                clickDelete: function (event) {
                    ...
                    if (recordId) {
                        ...
                        if (curScope && curScope.item) {
                            var confirmTitle = getResourceText("faircycle.labelDelete") + ": " + curScope.item.TITLE +
                                "\r\n" + getResourceText("faircycle.questionDelete");
                ...
                onLoadingStateChanged: function (eventInfo) {
                    ...
                    if (listView && listView.winControl) {
                        ...
                        if (listView.winControl.loadingState === "itemsLoading") {
                            if (!layout) {
                                layout = Application.FaircycleLayout.QuestionsLayout;
                    ...
                    if (eventInfo && eventInfo.detail && listView) {
                        ...
                        if (visible && that.nextUrl) {
                            ...
                            that.loadNext(function (json) {
                                ...
                                Log.print(Log.l.trace, "Faircycle loadNext: success!");
