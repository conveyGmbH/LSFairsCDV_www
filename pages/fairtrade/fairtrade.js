...
/// <reference path="~/www/pages/fairtrade/fairtradeController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.FairtradeLayout", {
        ...
        },
        {
            ...
            initialize: function (site) {
                ...
                WinJS.Utilities.addClass(this._surface, "fairtradeLayout");
            ...
            uninitialize: function () {
                WinJS.Utilities.removeClass(this._surface, "fairtradeLayout");
                this._site = null;
                this._surface = null;
            }
        })
    ...
    var pageName = Application.getPagePath("fairtrade");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [
                ...
                { id: "clickNew", label: getResourceText("command.new"), tooltip: getResourceText("tooltip.newfairtrade"), section: "primary", svg: "plus" },
                { id: "clickDelete", label: getResourceText("command.delete"), tooltip: getResourceText("tooltip.deleteFairtrade"), section: "primary", svg: "garbage_can" },
            ...
            this.controller = new Fairtrade.Controller(element, commandList);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var fairtrade = element.querySelector("#fairtrade.listview");
                    if (fairtrade && fairtrade.style) {
                        ...
                        if (contentarea) {
                            ...
                            if (width !== that.prevWidth) {
                                ...
                                fairtrade.style.width = width.toString() + "px";
                            }
                            if (height !== that.prevHeight) {
                                that.prevHeight = height;
                                fairtrade.style.height = height.toString() + "px";
                            }
                        }
                    }
                    that.inResize = 0;
