...
/// <reference path="~/www/pages/fairdatasrc/fairdatasrcController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.FairdatasrcLayout", {
        ...
        },
        {
            ...
            initialize: function (site) {
                ...
                WinJS.Utilities.addClass(this._surface, "fairdatasrcLayout");
            ...
            uninitialize: function () {
                WinJS.Utilities.removeClass(this._surface, "fairdatasrcLayout");
                this._site = null;
                this._surface = null;
            }
        })
    ...
    var pageName = Application.getPagePath("fairdatasrc");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [
                ...
                { id: "clickNew", label: getResourceText("command.new"), tooltip: getResourceText("tooltip.newFairdatasrc"), section: "primary", svg: "plus" },
                { id: "clickDelete", label: getResourceText("command.delete"), tooltip: getResourceText("tooltip.deleteFairdatasrc"), section: "primary", svg: "garbage_can" },
            ...
            this.controller = new Fairdatasrc.Controller(element, commandList);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var fairdatasrc = element.querySelector("#fairdatasrc.listview");
                    if (fairdatasrc && fairdatasrc.style) {
                        ...
                        if (contentarea) {
                            ...
                            if (width !== that.prevWidth) {
                                ...
                                fairdatasrc.style.width = width.toString() + "px";
                            }
                            if (height !== that.prevHeight) {
                                that.prevHeight = height;
                                fairdatasrc.style.height = height.toString() + "px";
                            }
                        }
                    }
                    that.inResize = 0;
