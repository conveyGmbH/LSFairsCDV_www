// controller for page: fairdatasrc
...
/// <reference path="~/www/pages/fairdatasrc/fairdatasrcService.js" />
...
(function () {
    ...
    WinJS.Namespace.define("Fairdatasrc", {
        Controller: WinJS.Class.derive(Application.RecordsetController, function Controller(pageElement, commandList) {
            Log.call(Log.l.trace, "Fairdatasrc.Controller.");
            // ListView control
            var listView = pageElement.querySelector("#fairdatasrc.listview");

            Application.RecordsetController.apply(this, [pageElement, {
                count: 0
            }, commandList, false, Fairdatasrc.initView, null, listView]);
                ...
                clickDelete: function (event) {
                    ...
                    if (recordId) {
                        ...
                        if (curScope && curScope.item) {
                            var confirmTitle = getResourceText("fairdatasrc.labelDelete") + ": " + curScope.item.TITLE +
                                "\r\n" + getResourceText("fairdatasrc.questionDelete");
                ...
                onLoadingStateChanged: function (eventInfo) {
                    ...
                    if (listView && listView.winControl) {
                        ...
                        if (listView.winControl.loadingState === "itemsLoading") {
                            if (!layout) {
                                layout = Application.FairdatasrcLayout.QuestionsLayout;
                    ...
                    if (eventInfo && eventInfo.detail && listView) {
                        ...
                        if (visible && that.nextUrl) {
                            ...
                            that.loadNext(function (json) {
                                ...
                                Log.print(Log.l.trace, "Fairdatasrc loadNext: success!");
