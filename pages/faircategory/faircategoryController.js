// controller for page: faircategory
...
/// <reference path="~/www/pages/faircategory/faircategoryService.js" />
...
(function () {
    ...
    WinJS.Namespace.define("Faircategory", {
        Controller: WinJS.Class.derive(Application.RecordsetController, function Controller(pageElement, commandList) {
            Log.call(Log.l.trace, "Faircategory.Controller.");
            // ListView control
            var listView = pageElement.querySelector("#faircategory.listview");

            Application.RecordsetController.apply(this, [pageElement, {
                count: 0
            }, commandList, false, Faircategory.initView, null, listView]);
                ...
                clickDelete: function (event) {
                    ...
                    if (recordId) {
                        ...
                        if (curScope && curScope.item) {
                            var confirmTitle = getResourceText("faircategory.labelDelete") + ": " + curScope.item.TITLE +
                                "\r\n" + getResourceText("faircategory.questionDelete");
                ...
                onLoadingStateChanged: function (eventInfo) {
                    ...
                    if (listView && listView.winControl) {
                        ...
                        if (listView.winControl.loadingState === "itemsLoading") {
                            if (!layout) {
                                layout = Application.FaircategoryLayout.QuestionsLayout;
                    ...
                    if (eventInfo && eventInfo.detail && listView) {
                        ...
                        if (visible && that.nextUrl) {
                            ...
                            that.loadNext(function (json) {
                                ...
                                Log.print(Log.l.trace, "Faircategory loadNext: success!");
