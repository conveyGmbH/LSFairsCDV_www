...
/// <reference path="~/www/pages/faircategory/faircategoryController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.FaircategoryLayout", {
        ...
        },
        {
            ...
            initialize: function (site) {
                ...
                WinJS.Utilities.addClass(this._surface, "faircategoryLayout");
            ...
            uninitialize: function () {
                WinJS.Utilities.removeClass(this._surface, "faircategoryLayout");
                this._site = null;
                this._surface = null;
            }
        })
    ...
    var pageName = Application.getPagePath("faircategory");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [
                ...
                { id: "clickNew", label: getResourceText("command.new"), tooltip: getResourceText("tooltip.newFaircategory"), section: "primary", svg: "plus" },
                { id: "clickDelete", label: getResourceText("command.delete"), tooltip: getResourceText("tooltip.deleteFaircategory"), section: "primary", svg: "garbage_can" },
            ...
            this.controller = new Faircategory.Controller(element, commandList);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var faircategory = element.querySelector("#faircategory.listview");
                    if (faircategory && faircategory.style) {
                        ...
                        if (contentarea) {
                            ...
                            if (width !== that.prevWidth) {
                                ...
                                faircategory.style.width = width.toString() + "px";
                            }
                            if (height !== that.prevHeight) {
                                that.prevHeight = height;
                                faircategory.style.height = height.toString() + "px";
                            }
                        }
                    }
                    that.inResize = 0;
