...
/// <reference path="~/www/pages/fairmanevent/fairmaneventController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.FairmaneventLayout", {
        ...
        },
        {
            ...
            initialize: function (site) {
                ...
                WinJS.Utilities.addClass(this._surface, "fairmaneventLayout");
            ...
            uninitialize: function () {
                WinJS.Utilities.removeClass(this._surface, "fairmaneventLayout");
                this._site = null;
                this._surface = null;
            }
        })
    ...
    var pageName = Application.getPagePath("fairmanevent");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [
                ...
                { id: "clickNew", label: getResourceText("command.new"), tooltip: getResourceText("tooltip.newFairmanevent"), section: "primary", svg: "plus" },
                { id: "clickDelete", label: getResourceText("command.delete"), tooltip: getResourceText("tooltip.deleteFairmanevent"), section: "primary", svg: "garbage_can" },
            ...
            this.controller = new Fairmanevent.Controller(element, commandList);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var fairmanevent = element.querySelector("#fairmanevent.listview");
                    if (fairmanevent && fairmanevent.style) {
                        ...
                        if (contentarea) {
                            ...
                            if (width !== that.prevWidth) {
                                ...
                                fairmanevent.style.width = width.toString() + "px";
                            }
                            if (height !== that.prevHeight) {
                                that.prevHeight = height;
                                fairmanevent.style.height = height.toString() + "px";
                            }
                        }
                    }
                    that.inResize = 0;
