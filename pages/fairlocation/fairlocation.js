...
/// <reference path="~/www/pages/fairlocation/fairlocationController.js" />

(function () {
    "use strict";

    WinJS.Namespace.define("Application.FairlocationLayout", {
        ...
        },
        {
            ...
            initialize: function (site) {
                ...
                WinJS.Utilities.addClass(this._surface, "fairlocationLayout");
            ...
            uninitialize: function () {
                WinJS.Utilities.removeClass(this._surface, "fairlocationLayout");
                this._site = null;
                this._surface = null;
            }
        })
    ...
    var pageName = Application.getPagePath("fairlocation");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [
                ...
                { id: "clickNew", label: getResourceText("command.new"), tooltip: getResourceText("tooltip.newFairlocation"), section: "primary", svg: "plus" },
                { id: "clickDelete", label: getResourceText("command.delete"), tooltip: getResourceText("tooltip.deleteFairlocation"), section: "primary", svg: "garbage_can" },
            ...
            this.controller = new Fairlocation.Controller(element, commandList);
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (element && !that.inResize) {
                ...
                ret = WinJS.Promise.timeout(0).then(function () {
                    var fairlocation = element.querySelector("#fairlocation.listview");
                    if (fairlocation && fairlocation.style) {
                        ...
                        if (contentarea) {
                            ...
                            if (width !== that.prevWidth) {
                                ...
                                fairlocation.style.width = width.toString() + "px";
                            }
                            if (height !== that.prevHeight) {
                                that.prevHeight = height;
                                fairlocation.style.height = height.toString() + "px";
                            }
                        }
                    }
                    that.inResize = 0;
