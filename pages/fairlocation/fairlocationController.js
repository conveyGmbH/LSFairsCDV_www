// controller for page: fairlocation
...
/// <reference path="~/www/pages/fairlocation/fairlocationService.js" />
...
(function () {
    ...
    WinJS.Namespace.define("Fairlocation", {
        Controller: WinJS.Class.derive(Application.RecordsetController, function Controller(pageElement, commandList) {
            Log.call(Log.l.trace, "Fairlocation.Controller.");
            // ListView control
            var listView = pageElement.querySelector("#fairlocation.listview");

            Application.RecordsetController.apply(this, [pageElement, {
                count: 0
            }, commandList, false, Fairlocation.initView, null, listView]);
                ...
                clickDelete: function (event) {
                    ...
                    if (recordId) {
                        ...
                        if (curScope && curScope.item) {
                            var confirmTitle = getResourceText("fairlocation.labelDelete") + ": " + curScope.item.TITLE +
                                "\r\n" + getResourceText("fairlocation.questionDelete");
                ...
                onLoadingStateChanged: function (eventInfo) {
                    ...
                    if (listView && listView.winControl) {
                        ...
                        if (listView.winControl.loadingState === "itemsLoading") {
                            if (!layout) {
                                layout = Application.FairlocationLayout.QuestionsLayout;
                    ...
                    if (eventInfo && eventInfo.detail && listView) {
                        ...
                        if (visible && that.nextUrl) {
                            ...
                            that.loadNext(function (json) {
                                ...
                                Log.print(Log.l.trace, "Fairlocation loadNext: success!");
